...
namespace USBClassLibrary
{
    ...
    {
        private const Int64 InvalidHandleValue = -1;
        ...
        private class Win32Wrapper
        {
            ...
            /// </summary>
            public struct GuidDeviceInterface
            {
                ...
                public const string SerenumBusEnumerator = "4D36E978-E325-11CE-BFC1-08002BE10318";
            ...
            public enum DeviceNotify : uint
            {
                ...
                DeviceNotifyServiceHandle = 0x00000001,
                DeviceNotifyAllInterfaceClasses = 0x00000004
            }
            
            public enum Dbtdevice : uint
            {
                DbtDeviceArrival = 0x8000,                 //A device has been inserted and is now available. 
                DbtDeviceQueryRemove = 0x8001,             //Permission to remove a device is requested. Any application can deny this request and cancel the removal.
                DbtDeviceQueryRemoveFailed = 0x8002,       //Request to remove a device has been canceled.
                DbtDeviceRemovePending = 0x8003,           //Device is about to be removed. Cannot be denied.
                DbtDeviceRemoveComplete = 0x8004,          //Device has been removed.
                DbtDeviceTypeSpecific = 0x8005,            //Device-specific event.
                DbtCustomEvent = 0x8006                    //User-defined event
            }
        ...
        public bool RegisterForDeviceChange(bool Register, IntPtr WindowsHandle)//System.Windows.Forms.Form f)
        {
            ...
            if (Register)
            {
                ...
                _deviceEventHandle = Win32Wrapper.RegisterDeviceNotification(WindowsHandle, buffer, (int)(Win32Wrapper.DeviceNotify.DeviceNotifyWindowHandle | Win32Wrapper.DeviceNotify.DeviceNotifyAllInterfaceClasses));
        ...
        public void ProcessWindowsMessage(int Msg, IntPtr WParam, IntPtr LParam, ref bool handled)//ref Message m)
        {
            ...
            if (Msg == Win32Wrapper.WmDeviceChange)
            {
                // WM_DEVICECHANGE can have several meanings depending on the WParam value...
                switch (WParam.ToInt32())
                {
                    case (int)Win32Wrapper.Dbtdevice.DbtDeviceArrival:
                    ...
                    case (int)Win32Wrapper.Dbtdevice.DbtDeviceQueryRemove:
                        ...
                        if (devType == Win32Wrapper.DBTDEVTYP.DBT_DEVTYP_DEVICEINTERFACE)
                        {
                            ...
                            UsbDeviceQueryRemove?.Invoke(this, e);
                        }
                    break;

                    case (int)Win32Wrapper.Dbtdevice.DbtDeviceRemoveComplete:
        ...
        public static bool GetUsbDevice(UInt32 vid, UInt32 pid, ref List<DeviceProperties> listOfDp, bool GetCOMPort, UInt32? MI=null)
        {
                        ...
                        if (success)
                        {
                            ...
                            if (success)
                            {
                                ...
                                if (lastError == Win32Wrapper.WinErrors.ERROR_INSUFFICIENT_BUFFER)
                                {
                                    ...
                                    {
                                        if (Win32Wrapper.SetupDiGetDeviceRegistryProperty(h, ref devInfoData, (UInt32)Win32Wrapper.SPDRP.SPDRP_HARDWAREID, ref regType, intPtrBuffer, BufferSize, ref requiredSize))
                                        {
                                                ...
                                                )
                                            {
                                                ...
                                                if (Win32Wrapper.SetupDiGetDeviceRegistryProperty(h, ref devInfoData, (UInt32)Win32Wrapper.SPDRP.SPDRP_FRIENDLYNAME, ref regType, intPtrBuffer, BufferSize, ref requiredSize))
                                                {
                                                    dp.FriendlyName = Marshal.PtrToStringAuto(intPtrBuffer);
                                                }

                                                dp.DeviceType = String.Empty;
                                                if (Win32Wrapper.SetupDiGetDeviceRegistryProperty(h, ref devInfoData, (UInt32)Win32Wrapper.SPDRP.SPDRP_DEVTYPE, ref regType, intPtrBuffer, BufferSize, ref requiredSize))
                                                {
                                                    dp.DeviceType = Marshal.PtrToStringAuto(intPtrBuffer);
                                                }

                                                dp.DeviceClass = String.Empty;
                                                if (Win32Wrapper.SetupDiGetDeviceRegistryProperty(h, ref devInfoData, (UInt32)Win32Wrapper.SPDRP.SPDRP_CLASS, ref regType, intPtrBuffer, BufferSize, ref requiredSize))
                                                {
                                                    dp.DeviceClass = Marshal.PtrToStringAuto(intPtrBuffer);
                                                }

                                                dp.DeviceManufacturer = String.Empty;
                                                if (Win32Wrapper.SetupDiGetDeviceRegistryProperty(h, ref devInfoData, (UInt32)Win32Wrapper.SPDRP.SPDRP_MFG, ref regType, intPtrBuffer, BufferSize, ref requiredSize))
                                                {
                                                    dp.DeviceManufacturer = Marshal.PtrToStringAuto(intPtrBuffer);
                                                }

                                                dp.DeviceLocation = String.Empty;
                                                if (Win32Wrapper.SetupDiGetDeviceRegistryProperty(h, ref devInfoData, (UInt32)Win32Wrapper.SPDRP.SPDRP_LOCATION_INFORMATION, ref regType, intPtrBuffer, BufferSize, ref requiredSize))
                                                {
                                                    dp.DeviceLocation = Marshal.PtrToStringAuto(intPtrBuffer);
                                                }

                                                dp.DevicePath = String.Empty;
                                                if (Win32Wrapper.SetupDiGetDeviceRegistryProperty(h, ref devInfoData, (UInt32)Win32Wrapper.SPDRP.SPDRP_LOCATION_PATHS, ref regType, intPtrBuffer, BufferSize, ref requiredSize))
                                                {
                                                    dp.DevicePath = Marshal.PtrToStringAuto(intPtrBuffer);
                                                }

                                                dp.DevicePhysicalObjectName = String.Empty;
                                                if (Win32Wrapper.SetupDiGetDeviceRegistryProperty(h, ref devInfoData, (UInt32)Win32Wrapper.SPDRP.SPDRP_PHYSICAL_DEVICE_OBJECT_NAME, ref regType, intPtrBuffer, BufferSize, ref requiredSize))
                                                {
                                                    dp.DevicePhysicalObjectName = Marshal.PtrToStringAuto(intPtrBuffer);
                                                }

                                                dp.DeviceDescription = String.Empty;
                                                if (Win32Wrapper.SetupDiGetDeviceRegistryProperty(h, ref devInfoData, (UInt32)Win32Wrapper.SPDRP.SPDRP_DEVICEDESC, ref regType, intPtrBuffer, BufferSize, ref requiredSize))
                                                {
                                                ...
                                                if (GetCOMPort)
                                                {
                                                    ...
                                                    {
                                                        var data = new StringBuilder(BufferSize);
                                                        UInt32 size = (UInt32)data.Capacity;
                                                        int result;

                                                        result = Win32Wrapper.RegQueryValueEx(hDeviceRegistryKey, "PortName", 0, out var type, data, ref size);
